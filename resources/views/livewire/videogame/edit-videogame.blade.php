                ...
                <div class="bg-base-100 dark:bg-base-300 shadow-md rounded-box">
                    <div class="p-6 text-base-content">
                        <div class="max-w-2xl mx-auto">
                            <h2 class="text-xl font-semibold mb-6 text-base-content">Edit Videogame</h2>
                            ...
                            <form wire:submit.prevent="save" class="flex flex-col gap-4">
                                ...
                                <div class="form-control w-full">
                                    ...
                                    <input type="text" wire:model="form.title" placeholder="Enter videogame title"
                                        class="input input-bordered w-full focus:outline-none @error('form.title') input-error @enderror" />
                                    @error('form.title')
                                        <label class="label">
                                ...
                                <div class="form-control w-full">
                                    ...
                                    <textarea wire:model="form.description" placeholder="Enter videogame description"
                                        class="textarea textarea-bordered w-full focus:outline-none @error('form.description') textarea-error @enderror"
                                        rows="4"></textarea>
                                ...
                                <div class="form-control w-full">
                                    ...
                                    <input type="file" wire:model="form.image" accept="image/*"
                                        class="file-input file-input-bordered w-full focus:outline-none @error('form.image') file-input-error @enderror" />
                                    @error('form.image')
                                        <label class="label">
                                            <span class="label-text-alt text-error">{{ $message }}</span>
                                        </label>
                                ...
                                <div class="form-control w-full">
                                    ...
                                    <input type="number" step="0.1" min="0" max="10"
                                        wire:model="form.rating" placeholder="0.0"
                                ...
                                <div class="form-control w-full">
                                    ...
                                    <input type="text" wire:model="form.category_name"
                                ...
                                <div class="form-control w-full">
                                    ...
                                    <input type="text" wire:model="form.studio_name"
                                ...
                                <div class="flex justify-end mt-6">
                                    <button type="submit" class="btn btn-secondary" wire:loading.attr="disabled"
                                        wire:target="save">
                                        <span wire:loading.remove wire:target="save">Edit Videogame</span>
