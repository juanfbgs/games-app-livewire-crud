...
<nav x-data="{ open: false }" class="bg-white dark:bg-base-200 border-b border-gray-100 dark:border-gray-600">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('videogames.index')" :active="request()->routeIs('videogames.*')" wire:navigate>
                        {{ __('Videogames') }}
                    </x-nav-link>
                </div>
